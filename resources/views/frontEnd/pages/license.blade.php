...
<span>your Id: {{$clientId}}</span>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{url('/key/create')}}" method="post">
        @csrf
        <div class="input-group mb-3">
          <label for="">Client Id</label>
          <input style="margin-left:40px;" type="text" class="form-control{{ $errors->has('clientID') ? ' is-invalid' : '' }}" name="clientID" value="{{ old('clientID') }}" placeholder="clientID">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" style="margin-left:16px;" class="form-control{{ $errors->has('licencekey') ? ' is-invalid' : '' }}" name="licencekey" value="{{ old('licencekey') }}" placeholder="">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-envelope"></span>
            </div>
